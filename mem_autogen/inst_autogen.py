...
feature_channel = 4 # Tn = 4
output_channel = 8 # Tm = 8
...
def fetch_weight(inst_list):
	for x in range(feature_channel):
		inst = "0401" + reformat_str(x*output_channel, 4) + reformat_str(x, 2) + "00" + reformat_str(8, 4)
		inst_list.append(inst)
		pass

def fetch_scaler(beginning_line, inst_list): # total scaler num: (img_line - 4)(img_column - 4)*Tm
	inst = "0404"+ reformat_str(32+beginning_line*24*8,4) +"000000"+reformat_str((img_column - 4)*output_channel,2)
	inst_list.append(inst)
