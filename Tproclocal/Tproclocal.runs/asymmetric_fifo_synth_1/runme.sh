...
HD_PWD='C:/Users/User2/Desktop/VivadoProjects/TDLA-i7server/Tproc/Tproclocal/Tproclocal.runs/asymmetric_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asymmetric_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asymmetric_fifo.tcl
