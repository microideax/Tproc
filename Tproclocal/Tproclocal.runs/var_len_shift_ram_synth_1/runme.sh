...
HD_PWD='C:/Users/User2/Desktop/VivadoProjects/TDLA-i7server/Tproc/Tproclocal/Tproclocal.runs/var_len_shift_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log var_len_shift_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source var_len_shift_ram.tcl
